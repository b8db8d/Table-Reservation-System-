...
import { store as storeRoute, index as indexRoute } from '@/routes/admin/tables/groups';
...
<template>
    <Head title="Add Joining Group" />

    <div class="flex flex-col gap-6 p-6">
        <h1 class="text-xl font-semibold">Add Joining Group</h1>
            ...
            <div class="rounded-xl border border-sidebar-border/70 bg-card p-6">
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div v-if="availableTables.length === 0" class="text-sm text-muted-foreground">
                            No ungrouped active tables available.
                        </div>
